...
// ValidateURL applies the same scheme allowlist used for links inside bullet
// text. Exported for header contact hrefs, which reach the template's
// link(...) without passing through the markup sanitizer.
